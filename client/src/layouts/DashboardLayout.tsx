...
const DashboardLayout = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen w-full bg-neo-bg text-neo-text">
            {/* Sidebar Area */}
            <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} />

            {/* Main Content Area */}
            <div className="flex flex-col flex-1 min-w-0 relative min-h-screen md:h-screen">
                ...
                <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-6 z-10 relative pb-20">
                    <Outlet />
                </main>
            </div>
        </div>
